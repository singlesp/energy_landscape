...
%% al857: also returning the distribution for plotting - otherwise identical

function [p_perm, rho_emp, rho_null_xy, rho_null_yx] = perm_sphere_p_al857(x,y,perm_id,corr_type)
...
rho_emp = corr(x,y,'type',corr_type, 'rows', 'complete');     % empirical correlation
